   ...
   <div class="container-lg height__container">
      <div class="row my-3">
        ...
        <div class="col-lg-9 col-12">
          <p class="fs-3 fw-semibold">Badminton žice</p>
          <div class="row">
          ...
          <div class="row mt-3 ps-3 gap-2 justify-content-sm-start justify-content-center">
            <?php $user->printCordsFilters("cords", "badminton")?>
          </div>
          <form id="pageForm" method="post">
            <?php $user->printPagesButtons("cords","badminton");?>
          </form>
        </div>
      </div>
   </div>

   ...
   <div class="container-lg height__container">
      <div class="row my-3">
          ...
          <form method="get">
            ...
            <div class="accordion-item">
              ...
              <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show">
                <div class="accordion-body body__filters">
                  <ul class="list-group">
                      <?php $user->clothingSize("clothing");?>
                  </ul>
                </div>
              </div>
              <div class="accordion-item">
        ...
        <div class="col-lg-9 col-12">
          <p class="fs-3 fw-semibold">Majce kratkih rukava</p>
          <div class="row">
          ...
          <div class="row mt-3 ps-3 gap-2 justify-content-sm-start justify-content-center">
            <?php $user->printClothingFilters("clothing","t-shirts");?>
          </div>
          <form id="pageForm" method="post">
            <?php $user->printPagesButtons("clothing","t-shirts");?>
          </form>
        </div>
      </div>
   </div>
